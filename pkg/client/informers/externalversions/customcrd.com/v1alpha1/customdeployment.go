...
import (
	...
	customcrdcomv1alpha1 "github.com/tahsinrahman/hello-k8s-crd/pkg/apis/customcrd.com/v1alpha1"
	versioned "github.com/tahsinrahman/hello-k8s-crd/pkg/client/clientset/versioned"
	internalinterfaces "github.com/tahsinrahman/hello-k8s-crd/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/tahsinrahman/hello-k8s-crd/pkg/client/listers/customcrd.com/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CustomcrdV1alpha1().CustomDeployments(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CustomcrdV1alpha1().CustomDeployments(namespace).Watch(options)
			},
		},
		&customcrdcomv1alpha1.CustomDeployment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *customDeploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&customcrdcomv1alpha1.CustomDeployment{}, f.defaultInformer)
}
