...
type FakeCustomDeployments struct {
	Fake *FakeCustomcrdV1alpha1
	ns   string
}

var customdeploymentsResource = schema.GroupVersionResource{Group: "customcrd.com", Version: "v1alpha1", Resource: "customdeployments"}

var customdeploymentsKind = schema.GroupVersionKind{Group: "customcrd.com", Version: "v1alpha1", Kind: "CustomDeployment"}
